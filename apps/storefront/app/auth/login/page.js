  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 bg-gray-50">
      <div className="w-full max-w-md bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
        ...
        <p className="text-gray-500 text-sm mb-7">Sign in to continue shopping</p>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-300 text-gray-700 py-2.5 rounded-xl text-sm font-medium hover:bg-gray-50 transition-colors"
        >
        ...
        <p className="text-center mt-6 text-sm text-gray-500">
          ...
          <Link href="/auth/register" className="text-gray-900 font-semibold underline">Create one</Link>
        </p>
      </div>
    </div>
  );

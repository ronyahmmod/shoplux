...
const inputCls =
  "w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent";
...
export default function CheckoutPage() {
  ...
  const validateCoupon = async () => {
    ...
    const res = await fetch(
      `/api/coupons/validate?code=${coupon}&subtotal=${subtotal}`,
    );
  ...
  if (cart.length === 0) {
    return (
      <div className="max-w-lg mx-auto px-4 py-24 text-center">
        ...
        <Link
          href="/products"
          className="inline-block bg-gray-900 text-white px-8 py-3 rounded-xl font-semibold hover:bg-gray-700 transition-colors"
        >
          Browse Products
        </Link>
      </div>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  <span
                    className={`text-sm ${paymentMethod === id ? "font-semibold text-gray-900" : "text-gray-600"}`}
                  >
                    {label}
                  </span>
                </label>
            ...
            {paymentMethod === "sslcommerz" && (
              <p className="mt-3 text-xs text-gray-500 bg-gray-100 rounded-lg px-3 py-2">
                ...
                Supports bKash, Nagad, cards and more.
              </p>
            )}
          </section>
          ...
          <div className="mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors shrink-0"
              >
                Apply
              </button>
            </div>

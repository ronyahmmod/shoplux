  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-3">
        ...
        <button className="px-4 py-3 rounded-lg border border-gray-300 text-gray-500 hover:border-gray-600 hover:text-gray-800 transition-all text-lg">
          ♡
        </button>
      </div>

      {cartItem && (
        <p className="text-sm text-gray-500">{cartItem.qty} already in your cart</p>
      )}
    </div>
  );
}
